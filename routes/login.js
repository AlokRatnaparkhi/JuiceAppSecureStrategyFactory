...
const SecureContext = require('../frontend/src/assets/javascript/SecureContext').SecureContext;
const Factory = require('../frontend/src/assets/javascript/Factory').Factory;
...
module.exports = function login () {
  ...
  return (req, res, next) => {
    ...
    '${insecurity.hash(req.body.password || '')}' AND deletedAt IS NULL`, { model: models.User, plain: true })
